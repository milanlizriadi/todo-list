...
<template>
  <main class="app">
    <section class="greeting">
      <h2 class="title">What's up, <input type="text" id="name" placeholder="Name here" autocomplete="off" v-model="name" /></h2>
    </section>
    ...
    <section class="create-todo">
      ...
      <form id="new-todo-form" @submit.prevent="addTodo">
        ...
        <input type="text" name="content" id="content" placeholder="e.g. make a video" autocomplete="off" v-model="input_content" />
